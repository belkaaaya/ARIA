...
public class Pasteries extends JFrame {
 ...
 private final Color color_RED   = new Color(0xFBF1D6);
    public Pasteries() {
        super("PASTERIES");
...
backArrow.addMouseListener(new MouseAdapter() {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        // ================= TITLE =================
        JLabel pageTitle = new JLabel("PASTERIES", SwingConstants.CENTER);
        ...
        listPanel.add(buildSavoryCard("croissant.png", "CROISSANT",
                "Feuilleté et doré à souhait, idéal pour accompagner ton café du matin", 3.0));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("chocoswirl.png", "CHOCO SWIRL",
                "Une viennoiserie feuilletée et dorée, au cœur fondant de chocolat pour un plaisir à chaque bouchée.", 4.5));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("brownies.png", "BROWNIES",
                "Fondant et riche en chocolat, un classique gourmand à savourer sans modération", 5.0));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("vanillamuffins.png", "VANILLA MUFFINS",
                "Moelleux et délicatement sucré, parfait avec un cappuccino ou un latte", 5.5));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("chocolatdonuts.png", "CHOCOLAT DONUTS",
                "Généreusement nappé de chocolat, un plaisir crousti-moelleux irrésistible", 7.0));
...
heartBtn.addActionListener(e -> {
    ...
    if (nowLike) {
        ...
        System.out.println("[Pasteries] like " + title + " w=" +
...
public static void main(String[] args) {
    SwingUtilities.invokeLater(() -> new Pasteries().setVisible(true));
}
