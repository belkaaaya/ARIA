...
public class Savory extends JFrame {
...
backArrow.addMouseListener(new MouseAdapter() {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        // ================= TITLE =================
        JLabel pageTitle = new JLabel("SAVORY BRUNCH", SwingConstants.CENTER);
        ...
        listPanel.add(buildSavoryCard("savorycroissant.png", "SAVORY CROISSANT",
                "Feuilleté doré et savoureux, idéal pour accompagner ton café du matin.", 3.0));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("savorybagels.png", "SAVORY BAGELS",
                "Moelleux et généreux, garnis d’ingrédients frais pour un plaisir salé équilibré.", 4.5));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("eggstoast.png", "EGGS TOAST",
                "Pain doré garni d’œufs et de fromage, parfait pour un brunch gourmand.", 5.0));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("avocattoast.png", "AVOCADO TOAST",
                "Tartine onctueuse à l’avocat frais, relevée d’une touche de citron.", 5.5));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("mixedplat.png", "MIXED PLAT",
                "Assortiment équilibré d’œufs, de légumes et de pain pour un repas complet.", 7.0));
...
heartBtn.addActionListener(e -> {
    ...
    if (nowLike) {
        ...
        System.out.println("[Savory] like " + title + " w=" +
...
private static ImageIcon scaleIcon(ImageIcon src, int w, int h) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new Savory().setVisible(true));
    }
