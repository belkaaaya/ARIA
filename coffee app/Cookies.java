...
public class Cookies extends JFrame {
 ...
 //back arrow
        ...
        // ================= TITLE =================
        JLabel pageTitle = new JLabel("COOKIES", SwingConstants.CENTER);
        ...
        listPanel.add(buildSavoryCard("cookie.png", "COOKIE",
                "Doré et croustillant à l’extérieur, moelleux à l’intérieur — le compagnon parfait pour ton café du matin.", 3.0));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("chocolatcookie.png", "CHOCOLAT COOKIE",
                "Intense et fondant, généreusement garni de pépites de chocolat noir pour une pause ultra gourmande.", 4.5));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("matchacookie.png", "MATCHA COOKIE",
                "Une douceur équilibrée au thé matcha, subtilement sucrée et délicatement parfumée.", 5.0));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("pinkcookie.png", "PINK COOKIE",
                "Légèrement acidulé à la framboise, ce cookie fondant séduit par sa couleur douce et son goût fruité.", 5.5));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("oreocookie.png", "OREO COOKIE",
                "Une base moelleuse et des morceaux d’Oreo croquants pour un plaisir régressif et irrésistible.", 7.0));
...
heartBtn.addActionListener(e -> {
    ...
    if (nowLike) {
        ...
        System.out.println("[Cookies] like " + title + " w=" +
...
private static ImageIcon scaleIcon(ImageIcon src, int w, int h) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new Cookies().setVisible(true));
    }
}