...
backArrow.addMouseListener(new MouseAdapter() {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        // ================= TITLE =================
        JLabel pageTitle = new JLabel("Drinks", SwingConstants.CENTER);
        ...
        listPanel.add(buildSavoryCard("orange.png", "ORANGE JUICE",
                "Pressé à froid, riche en vitamines et en fraîcheur — l’énergie parfaite pour bien commencer la journée", 3.0));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("mojito.png", "MOJITO",
                "Un mélange pétillant de menthe fraîche, citron vert et glaçons pour un moment intensément rafraîchissant.", 4.5));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("berry.png", "berry lemonade",
                "Une limonade acidulée relevée par des fruits rouges juteux, parfaite pour une pause sucrée et vitaminée.", 5.0));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("icedtea.png", "ICED TEA",
                "Un thé glacé légèrement sucré, infusé avec des notes fruitées et servi bien frais pour un instant douceur.", 5.5));
        listPanel.add(Box.createVerticalStrut(12));

        listPanel.add(buildSavoryCard("watermelon.png", "WATERMELON JUICE",
                "Frais, désaltérant et naturellement sucré — le goût d’été dans un verre, à savourer à tout moment.", 7.0));
...
heartBtn.addActionListener(e -> {
    ...
    if (nowLike) {
        ...
        System.out.println("[ColdCoffees] like " + title + " w=" +
...
private static ImageIcon scaleIcon(ImageIcon src, int w, int h) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new Drinks().setVisible(true));
    }
}
