...
headerRow.add(backArrow, BorderLayout.WEST);
        ...
        // ================= TITLE =================
        JLabel pageTitle = new JLabel("hot coffees", SwingConstants.CENTER);
        ...
        listPanel.add(buildSavoryCard("latteh.png", "LATTE",
                "Doux et équilibré, l’union parfaite du café et du lait chaud", 4.0));
        listPanel.add(Box.createVerticalStrut(12));
        listPanel.add(buildSavoryCard("americanohh.png", "americano",
                "Le juste milieu entre intensité et légèreté, à savourer lentement.", 3.5));
        listPanel.add(Box.createVerticalStrut(12));
        
        listPanel.add(buildSavoryCard("mochah.png", "mocha",
                "Espresso et chocolat blanc pour une touche sucrée", 5.0));
        listPanel.add(Box.createVerticalStrut(12));
        
         listPanel.add(buildSavoryCard("capuccinoh.png", "CAPPUCCINO",
                "Un mélange parfait d’espresso, de lait chaud et de mousse onctueuse", 7.0));
        listPanel.add(Box.createVerticalStrut(20));


        listPanel.add(buildSavoryCard("esspressoo.png", "esspresso",
                "Un café court et puissant, à l’arôme intense pour un réveil plein d’énergie", 5.5));
        listPanel.add(Box.createVerticalStrut(12));
...
heartBtn.addActionListener(e -> {
    ...
    if (nowLike) {
        ...
        System.out.println("HotCoffee] like " + title + " w=" +
...
private static ImageIcon scaleIcon(ImageIcon src, int w, int h) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new HotCoffee().setVisible(true));
    }
}